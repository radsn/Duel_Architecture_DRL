...
from keras.layers import Add, Conv2D, Input, Lambda, Subtract
...
class DuelQ(object):
    ...
    def construct_q_network(self):
        ...
        value = Dense(1)(fc2)
        advntg_norm = Lambda(lambda x: x-K.mean(x))(advantage)
        policy = Add()([value, advntg_norm])  # - K.mean(advantage)])
